...
public class JavaSeleniumBase {
	...
	public static Properties configurationProperty;
	public static WebDriver browserWebdriverLocal;
	public static WebDriver browserWebdriverRemote;
	
	public static void setConfigurationProperties() throws IOException {

		configurationProperty = new Properties();
	...
	public static void setBrowserWebdriverLocal() throws IOException {
	...
	public static void setBrowserWebdriverRemote() throws IOException {
